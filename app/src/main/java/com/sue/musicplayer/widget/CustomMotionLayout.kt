package com.sue.musicplayer.widget
...
/**
 * Created by sujeong on 2021/09/02
 * Description :
 */
class CustomMotionLayout(
    ...
    private val bottomPlayerLayout by lazy {
        findViewById<View>(R.id.bottomPlayerLayout)
    }
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if( motionTouchStarted.not() ) {
            bottomPlayerLayout.getHitRect(hitRect)
